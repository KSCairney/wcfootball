...
class TestGroupsControllerTest < ActionController::TestCase
  ...
  test "should create test_group" do
    assert_difference('TestGroup.count') do
      post :create, test_group: { name: @test_group.name, team_id: @test_group.team_id, user_id: @test_group.user_id }
    end
  ...
  test "should update test_group" do
    patch :update, id: @test_group, test_group: { name: @test_group.name, team_id: @test_group.team_id, user_id: @test_group.user_id }
    assert_redirected_to test_group_path(assigns(:test_group))
  end
